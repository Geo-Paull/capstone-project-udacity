 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "    # write immigration_fact table to parquet files partitioned by state and city\n",
    ...
    "    dim_immigration_personal = df.select('cicid', 'i94cit', 'i94res',\\\n",
